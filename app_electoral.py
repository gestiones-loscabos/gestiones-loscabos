...
# ==========================================
    ...
    with st.form("form_simpatizantes_comunes"):
        ...
        msg_inv_sc = f"¡Hola {nombre_scom}! Te damos la bienvenida a la red de simpatizantes comunes de nossa Casa Amiga. Síguenos en nuestras redes oficiales."
...
# ==========================================
    ...
    with col_sim_cen:
        ...
        with st.form("form_tracking_poll_oficial"):
            ...
            p2_conoce_cand = st.radio("2. ¿Ha escuchado hablar o conoce al candidato?", ["Sí", "No"], horizontal=True)
